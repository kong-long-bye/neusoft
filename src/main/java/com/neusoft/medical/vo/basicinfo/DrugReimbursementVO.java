 ...
 * @date 2025-07-10
 */
@ApiModel(description = "药品报销比例传输对象")
public class DrugReimbursementVO {

    @ApiModelProperty(value = "主键")
    private Integer id;

    @ApiModelProperty(value = "报销等级类型", required = true, example = "甲类药品")
    private String drugReimbursementType;

    @ApiModelProperty(value = "报销比例", required = true, example = "100")
    private Integer drugReimbursementProportion;

    @ApiModelProperty(value = "报销等级信息", example = "全部纳入医保基金支付范围")
