 ...
 * @date 2025-07-10
 */
@ApiModel(description = "诊疗项目传输对象")
public class TreatmentVO {

    @ApiModelProperty(value = "主键")
    private Integer id;

    @ApiModelProperty(value = "项目类别", required = true, example = "检查")
    private String medicalType;

    @ApiModelProperty(value = "项目编码", required = true, example = "CT001")
    private String medicalNumber;

    @ApiModelProperty(value = "项目国家编码", example = "310101001")
    private String countryNumber;

    @ApiModelProperty(value = "项目名称", required = true, example = "CT检查-胸部")
    private String medicalName;

    @ApiModelProperty(value = "项目说明", example = "胸部CT平扫检查")
    private String medicalInfo;

    @ApiModelProperty(value = "除外内容", example = "增强扫描除外")
    private String medicalExclude;

    @ApiModelProperty(value = "计价单位", example = "次")
    private String medicalUnit;

    @ApiModelProperty(value = "价格", example = "300.00")
